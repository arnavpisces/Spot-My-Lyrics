...
public class MainActivity extends AppCompatActivity implements LyricsListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent serviceIntent=new Intent(this,GetSongInformation.class);
...
//
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, CHANNEL_ID)
                .setSmallIcon(R.mipmap.ic_launcher)
                .setContentTitle("Lyrics Are Available")
                .setContentText("Tap here to check out the lyrics...")
                .setStyle(new NotificationCompat.BigTextStyle()
                        .bigText("Just Tap Bruh.."))
